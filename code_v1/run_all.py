...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="Max tokens for image descriptions (lower = shorter)",
    )
    parser.add_argument(
    ...
    lm_max_tokens = config.get("LM_STUDIO_MAX_TOKENS", "512")
    dpi = args.dpi
    ...
    phases = [
        ...
        (
            ...
            "phase4/build_md.py",
            [str(phases_dir / "phase3_zones.json"), "--output-dir", str(output_dir)],
        ),
    ]

    # Inject LM Studio URL + prompts path into Phase 3 args if available
    if args.local_lm:
    ...
    if args.invisible:
        ...
        phases[2][3].append("--invisible")  # Phase 3
